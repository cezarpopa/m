      ...
      <div class="card-body">
        <div class="position-relative my-3">
          ...
          <label class="form-check-label fw-bold" for="core-display">
            {{ pluginsUpdates.display ? 'Hide' : 'Show ' }} plugins updates section?</label>
        </div>
           ...
           toolbar:
            ...
            <div class="row">
              <div class="col-12 mt-3">
                <label class="form-check-label fw-bold mb-3" for="plugin-typeahead">Search and select updated
                  plugins</label>
              ...
              <div class="col-12">
                <div class="card my-4" v-if="pluginsList.length > 0">
                  <div class="card-body">
                    <ol>
                      <li class="col-12 mb-3 ps-2" v-for="(item, index) in pluginsList" :key="item.slug">
                        <img
                            class="me-2"
                            v-if="item.hasOwnProperty('icons')"
                            width="30"
                            height="30"
                            :src="item.icons['2x'] ?? item.icons['1x']"
                            :alt="item.name"/>
                          <div class="d-inline">
