    ...
    <div class="card shadow-lg rounded-1">
      <div class="card-body">
        ...
        <div v-if="health.display">
          <label class="form-check-label fw-bold" for="health-title">Section heading</label>
          <input class="px-0 h2 fw-bold w-100 mb-4" type="text" name="health-title" v-model="health.title">
          <Editor
              api-key="no-api-key"
